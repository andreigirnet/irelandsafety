...
@section('content')
    <div class="mh-leadership-page">
            ...
            <div class="mh-container">
                <div class="mh-hero-content">
                    ...
                    <p class="mh-lead-text">
                        The essential **Safe Operation Curriculum** for the Irish industrial workforce.
                        Secure your **Operator Proficiency Verification** with our 2026 standards-aligned framework. Master the selection, use, and maintenance of life-critical equipment.
                    </p>
        ...
        <article class="mh-container-content">
            ...
            <p>This **Safe Operation Curriculum** serves as a vital foundation for understanding the "Hierarchy of Control". PPE is legally defined as the "last resort" in workplace safety—it only protects the wearer and does not eliminate the hazard itself. Without a baseline of **Digital Safety Instruction Online**, employees often use equipment that is ill-fitting, damaged, or inappropriate for the specific hazard. Our platform ensures your team is compliant with regulatory guidelines and prepared to maintain their "Last Line of Defense" with total confidence.</p>
        ...
        <article class="mh-container-content">
            ...
            <p>Every **Operator Proficiency Verification** must address the "Shelf-Life" of safety equipment, particularly polymers used in hard hats and fall-arrest lanyards.</p>
        ...
        <article class="mh-container-content">
            ...
            <p>For Dublin project managers and nationwide warehouse supervisors, the logistics of PPE training can be overwhelming. Our **Operator Proficiency Verification** removes the need for expensive classroom hire and travel. Your team can complete their **Safe Operation Curriculum** at their own pace, ensuring they are certified and audit-ready in under an hour.</p>
