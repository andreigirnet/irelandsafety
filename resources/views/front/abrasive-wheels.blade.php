...
@section('content')
    <div class="mh-leadership-page">
            ...
            <div class="mh-container">
                <div class="mh-hero-content">
                    ...
                    <p class="mh-lead-text">
                        The definitive **Safe Operation Curriculum** for the Irish industrial sector.
                        Secure your **Operator Proficiency Verification** with our 2026 standards-aligned framework. Professional safety for precision engineering.
                    </p>
        ...
        <article class="mh-container-content">
            ...
            <p>This **Safe Operation Curriculum** is designed to satisfy the legal "Duty of Care" placed on employers to provide competent instruction. Without a valid **Operator Proficiency Verification**, operators are not permitted to mount wheels on grinders, cut-off saws, or bench grinders. Our **Digital Safety Instruction Online** ensures your workforce meets these regulatory thresholds without the downtime associated with classroom learning.</p>

            <div class="mh-feature-list">
                <li><strong>Legal Shield:</strong> Compliant with Schedule 5 regulatory requirements.</li>
        ...
        <article class="mh-container-content">
            ...
            <p>Our **Digital Safety Instruction Online** provides a deep dive into **Wheel Anatomy**. We explain the difference between Vitrified, Resinoid, and Diamond bonds, and how environmental factors like moisture and temperature can degrade these materials over time. Understanding the "Expiry Date" (V-code) marked on the metal center is critical for ensuring that your **Operator Proficiency Verification** actually translates to a safer workshop.</p>

            <h3>Mandatory Inspection: The Ring Test</h3>
            <p>One of the most vital practical skills covered in this **Safe Operation Curriculum** is the Ring Test. By gently tapping a dry, clean wheel with a non-metallic implement, a competent operator can listen for the characteristic "clear ring" that indicates a sound structure. A "dull thud" signals an internal crack, necessitating the immediate destruction and disposal of the wheel.</p>
        </article>

        <article class="mh-container-content">
            <h2>Operational Risk Management</h2>
            <p>Beyond the wheel itself, this **Safe Operation Curriculum** addresses the broader environment. **Vibration White Finger** (Hand-Arm Vibration Syndrome) and **Respiratory Damage** from fine particulate matter are significant long-term occupational risks in Ireland.</p>
        ...
        <article class="mh-container-content">
            <h2>Secure Your Industrial Operator Proficiency Verification</h2>
            <p>For Dublin engineering firms and nationwide manufacturing sites, keeping up with safety instruction is a constant logistical challenge. Our **Operator Proficiency Verification** removes the need for site visits and half-day shutdowns. Your operators can complete their **Safe Operation Curriculum** during quiet periods, ensuring they remain productive while staying compliant.</p>

            <p>With 24/7 access on all devices, our **Digital Safety Instruction Online** is the most cost-effective solution for modern Irish industry. Join the 50,000+ professionals who trust our platform for their mandatory compliance credentials.</p>
