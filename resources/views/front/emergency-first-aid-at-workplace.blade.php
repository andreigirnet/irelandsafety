...
@section('content')
    <div class="mh-leadership-page">
            ...
            <div class="mh-container">
                <div class="mh-hero-content">
                    ...
                    <p class="mh-lead-text">
                        The essential **Safe Operation Curriculum** for the modern Irish workforce.
                        Secure your **Operator Proficiency Verification** with our 2026 standards-aligned framework. Professional readiness for every workplace emergency.
                    </p>
                    <div class="mh-btn-row">
                        <a href="{{route('register')}}" class="btn-exclusive-teal">Start First Aid Training — €{{ config('global.course_price') }}</a>
        ...
        <article class="mh-container-content">
            ...
            <p>In the Republic of Ireland, the provision of first aid is a strict statutory requirement under the <strong>Safety and Welfare at Work (General Application) Regulations 2007</strong>, Part 7, Chapter 2. Employers are legally obligated to provide a sufficient number of "First Aid Responders" and adequate equipment to ensure that employees receive immediate assistance if injured or taken ill at work.</p>

            <p>This **Safe Operation Curriculum** serves as a vital "Awareness and Theory" foundation for all staff members, complementing the physical practical requirements mandated for designated responders. Without a baseline of **Digital Safety Instruction Online**, the "Chain of Survival" is often broken before professional medical help arrives. Our platform ensures your team is compliant with regulatory guidelines and prepared to act decisively during the "Golden Hour" of emergency care.</p>

            <div class="mh-feature-list">
                <li><strong>Legal Shield:</strong> Aligned with the 2007 General Application Regulations.</li>
                <li><strong>Audit Ready:</strong> Every **Operator Proficiency Verification** includes a unique verification ID.</li>
            </div>
        </article>
        ...
        <article class="mh-container-content">
            ...
            <p>The foundation of all **Digital Safety Instruction Online** regarding first aid is the <strong>Primary Survey</strong>. This systematic approach ensures that life-threatening conditions are identified and treated in order of priority. In a high-pressure workplace emergency, following a memorized acronym prevents "tunnel vision" and saves lives.</p>

            <p>Our **Safe Operation Curriculum** provides a deep dive into <strong>CPR (Cardiopulmonary Resuscitation)</strong> mechanics. We explain the physiological importance of high-quality chest compressions—at least 5cm deep and at a rate of 100-120 beats per minute—to maintain oxygenated blood flow to the brain. This is particularly critical in Dublin’s industrial and office environments where cardiac events are a leading cause of sudden collapse.</p>
        ...
        <article class="mh-container-content">
            ...
            <p>Every **Operator Proficiency Verification** must address the specific risks found in Irish workplaces, from retail to heavy manufacturing.</p>
        ...
        <article class="mh-container-content">
            ...
            <p>For Dublin HR managers and nationwide facilities supervisors, the logistics of first aid training can be overwhelming. Our **Operator Proficiency Verification** removes the need for expensive classroom hire and travel for the theoretical portion of the training. Your team can complete their **Safe Operation Curriculum** at their own pace, ensuring they are certified and audit-ready in under an hour.</p>
