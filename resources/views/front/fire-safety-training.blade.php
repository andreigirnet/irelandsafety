...
@section('content')
    <div class="mh-leadership-page">
            ...
            <div class="mh-container">
                <div class="mh-hero-content">
                    ...
                    <p class="mh-lead-text">
                        The premier **Safety Course** for Irish businesses.
                        Establish total **Fire Safety Compliance Ireland** with our standards-aligned curriculum. Secure your **Operator Proficiency Verification** and protect your workforce today.
                    </p>
        ...
        <article class="mh-container-content">
            ...
            <p>In the Republic of Ireland, fire safety is a non-negotiable legal requirement governed by two primary pieces of legislation: the <strong>Fire Services Acts 1981 and 2003</strong> and the <strong>Safety and Welfare at Work Act 2005</strong>. Under Section 18 of the Fire Services Act, the "person having control" over a premises must take all reasonable measures to prevent a fire from starting and ensure the safety of all persons on-site if a fire occurs.</p>

            <p>This **Safe Operation Curriculum** is designed to satisfy the requirement for "appropriate training and instruction" for all staff members. Without a verified **Operator Proficiency Verification**, an employer may be held liable for criminal negligence in the event of an incident. Our **Digital Safety Instruction Online** platform ensures your business remains audit-ready for regulatory inspections while building a proactive culture of fire prevention.</p>

            <div class="mh-feature-list">
                <li><strong>Legal Shield:</strong> Fully compliant with the 2005 Safety Act and recent Fire Service updates.</li>
                <li><strong>Nationwide Trust:</strong> Accepted by Irish insurers and workplace safety standards.</li>
            </div>
        </article>
        ...
        <article class="mh-container-content">
            ...
            <p>A central component of this **Digital Safety Instruction Online** is the study of fire development. Fire is a chemical reaction that follows a predictable path of growth: Incipient, Growth, Fully Developed, and Decay. In modern Irish offices and warehouses, fires can reach "Flashover"—the point where every combustible surface in a room ignites simultaneously—in less than five minutes.</p>

            <p>Our **Safe Operation Curriculum** explores the three methods of fire spread: <strong>Conduction</strong> (through solid materials), <strong>Convection</strong> (through hot air/smoke), and <strong>Radiation</strong> (through infrared waves). Understanding that smoke is the primary killer in building fires—carrying toxic gases like Carbon Monoxide—is essential for any worker seeking **Operator Proficiency Verification**. We emphasize the role of "Compartmentation" and fire-rated doors in containing these hazards to protect escape routes.</p>

            <h3>Common Causes of Workplace Fires</h3>
            <p>Recent statistics highlight preventable causes as the main drivers of Irish workplace fires:</p>
            <ul class="mh-v8-list">
        ...
        <article class="mh-container-content">
            ...
            <p>In a fire emergency, human behavior often shifts to "Panic" or "Denial." Our **Digital Safety Instruction Online** uses behavioral psychology to train workers to recognize the alarm immediately and proceed to the nearest exit without hesitation.</p>
        ...
        <article class="mh-container-content">
            ...
            <p>For HR Managers in Dublin, Cork, and Galway, coordinating in-person safety training is a logistical and financial burden. Our **Operator Proficiency Verification** removes these barriers, offering a 100% digital, self-paced curriculum that can be completed on any device in just 45-60 minutes.</p>

            <p>With 24/7 access and instant PDF delivery, our **Digital Safety Instruction Online** is the most cost-effective path to compliance for modern Irish businesses. Join over 350,000 professionals who have trusted our platform to secure their mandatory compliance credentials.</p>
